...
go version
```
The output should be `go version go1.22.0 linux/amd64`
...
To verify the installation you can run `chihuahuad version` and it should return `v8.0.2`
...
# Chain Upgrades
- **v8.0.0** - Block 15103000 - (2024-10-22 13:50:00)

...
import (
	...
	app "github.com/ChihuahuaChain/chihuahua/app"
	treasurytypes "github.com/ChihuahuaChain/chihuahua/x/treasury/types"
	//wasmconfig "github.com/ChihuahuaChain/chihuahua/x/wasm/config"
)
...
func createTestApp(isCheckTx bool, tempDir string) (*app.App, sdk.Context) {
	app := app.New(
		...
		tempDir, simapp.FlagPeriodValue, app.MakeEncodingConfig(),

...
const baseParams = { maxMemoCharacters: 0, txSigLimit: 0, txSizeCostPerByte: 0, sigVerifyCostEd25519: 0, sigVerifyCostSecp256k1: 0, txFeeBurnPercent: 0 };
export const Params = {
    encode(message, writer = Writer.create()) {
        ...
        if (message.txFeeBurnPercent !== 0) {
            writer.uint32(48).uint64(message.txFeeBurnPercent);
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    message.txFeeBurnPercent = longToNumber(reader.uint64());
                    break;
                default:

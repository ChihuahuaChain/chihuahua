...
func (s *IntegrationTestSuite) TestIBCTokenTransfer() {
	...
	chainA.SendIBC(chainB, chainB.NodeConfigs[0].PublicAddress, initialization.ChihuahuaToken)
	chainB.SendIBC(chainA, chainA.NodeConfigs[0].PublicAddress, initialization.ChihuahuaToken)
...
// 	// Store Contract
// 	node.StoreWasmCode("/chihuahua/tokenfactory.wasm", wallet)
...
// 	ourDenom := fmt.Sprintf("factory/%s/test", contractAddr) // factory/chihuahua14hj2tavq8fpesdwxxcu44rty3hh90vhujrvcmstl4zr3txmfvw9skjuwg8/test
...
// 	msg = fmt.Sprintf(`{"change_admin":{"denom":"%s","new_admin_address":"%s"}}`, ourDenom, "chihuahua1aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaavju90c")
// 	node.WasmExecute(contractAddr, msg, wallet, "", tfSuccessCode)
// }

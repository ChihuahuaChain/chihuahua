...
If it's huahua token, stakedrop huahua amount will be sent to module to be distributed then to stakers

Only whitelisted address in tokenfactory params will be able to create stakedrop

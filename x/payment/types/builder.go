...
// KeyringSigner uses a keyring to sign and build chihuahua transactions
...
// NewTxBuilder returns the default sdk Tx builder using the chihuahua encoding config
...
// QueryAccount fetches the account number and sequence number from the chihuahua node.

...
import (
	...
	v04treasury "github.com/ChihuahuaChain/chihuahua/x/treasury/legacy/v04"
	v05treasury "github.com/ChihuahuaChain/chihuahua/x/treasury/legacy/v05"
)
...
func TestMigrate(t *testing.T) {
	...
	treasuryGenState := v04treasury.GenesisState{
		...
		TaxCaps: map[string]sdk.Int{
			core.MicroHuahuaDenom: sdk.NewInt(1),
			core.MicroSDRDenom:    sdk.NewInt(100),
		},
		TaxProceed: sdk.NewCoins(
			sdk.NewCoin(core.MicroHuahuaDenom, sdk.NewInt(100)),

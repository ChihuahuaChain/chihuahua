...
func (uc *UpgradeConfigurer) ConfigureChain(chainConfig *chain.Config) error {
	...
	tmpDir, err := os.MkdirTemp("", "chihuahua-e2e-testnet-")
	if err != nil {
		return err
	}
...
func (uc *UpgradeConfigurer) upgradeContainers(chainConfig *chain.Config, propHeight int64) error {
	...
	uc.containerManager.ChihuahuaRepository = containers.CurrentBranchRepository
	uc.containerManager.ChihuahuaTag = containers.CurrentBranchTag

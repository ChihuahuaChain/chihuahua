...
$ chihuahuad query treasury tax-rate
`),
...
$ chihuahuad query treasury tax-cap ukrw
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
...
$ chihuahuad query treasury tax-caps
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
...
$ chihuahuad query treasury reward-weight
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
...
$ chihuahuad query treasury tax-proceeds
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {
...
func GetCmdQuerySeigniorageProceeds() *cobra.Command {
	cmd := &cobra.Command{
		...
		Long: strings.TrimSpace(`
Query the seigniorage proceeds corresponding to the current epoch. The return value will be in units of 'uhuahua' coins. 

$ chihuahuad query treasury seigniorage-proceeds
`),
		RunE: func(cmd *cobra.Command, args []string) error {
			clientCtx, err := client.GetClientQueryContext(cmd)
			if err != nil {

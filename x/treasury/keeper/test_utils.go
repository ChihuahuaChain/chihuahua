...
import (
	...
	// customauth "github.com/ChihuahuaChain/chihuahua/custom/auth"
	// custombank "github.com/ChihuahuaChain/chihuahua/custom/bank"
	// customdistr "github.com/ChihuahuaChain/chihuahua/custom/distribution"
	// customparams "github.com/ChihuahuaChain/chihuahua/custom/params"
	// customstaking "github.com/ChihuahuaChain/chihuahua/custom/staking"
	core "github.com/ChihuahuaChain/chihuahua/types"
	customauth "github.com/cosmos/cosmos-sdk/x/auth"
	...
	// "github.com/ChihuahuaChain/chihuahua/x/oracle"
	// oraclekeeper "github.com/ChihuahuaChain/chihuahua/x/oracle/keeper"
	// oracletypes "github.com/ChihuahuaChain/chihuahua/x/oracle/types"
...
var (
	...
	InitCoins  = sdk.NewCoins(sdk.NewCoin(core.MicroHuahuaDenom, InitTokens))
)
...
func CreateTestInput(t *testing.T) TestInput {
	...
	totalSupply := sdk.NewCoins(sdk.NewCoin(core.MicroHuahuaDenom, InitTokens.MulRaw(int64(len(Addrs)*10))))
	...
	stakingParams.BondDenom = core.MicroHuahuaDenom
	...
	// + 1 for burn account
	bankKeeper.SendCoinsFromModuleToModule(ctx, faucetAccountName, stakingtypes.NotBondedPoolName, sdk.NewCoins(sdk.NewCoin(core.MicroHuahuaDenom, InitTokens.MulRaw(int64(len(Addrs)+1)))))
...
func NewTestMsgCreateValidator(address sdk.ValAddress, pubKey cryptotypes.PubKey, amt sdk.Int) *stakingtypes.MsgCreateValidator {
	...
	msg, _ := stakingtypes.NewMsgCreateValidator(
		address, pubKey, sdk.NewCoin(core.MicroHuahuaDenom, amt),
